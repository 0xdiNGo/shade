...
**M6 (next)** — see `docs/Roadmap.md`. MVP polish: Ansible role, container deployment, in-channel `/MSG TOKEN` admin commands, the rest of the chanset toggles, integration tests against ergo in CI.
